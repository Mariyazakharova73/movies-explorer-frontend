      ...
      <div className="about-me__wrapper">
        <div>
          ...
          <p className="about-me__description">
            Я живу в Ульяновске, закончила факультет "Электроснабжение" УлГТУ. Я люблю слушать
            музыку, смотреть фильмы и сериалы, путешествовать, проводить время с семьей и друзьями.
            В марте 2022 года уволилась с должности инженера-конструктора и начала проходить курс по
            веб-разработке.
          </p>
          <a
